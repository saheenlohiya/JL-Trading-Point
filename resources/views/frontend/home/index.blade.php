				...
				<div class="row">
					<div id="carouselExampleCaptions" class="carousel slide gx-0" data-bs-ride="false">
						...
						<div class="carousel-inner">
							<div class="carousel-item active"> <img src="./images/slide1.jpg" class="d-block w-100 slider_height" alt="...">
							...
							<div class="carousel-item"> <img src="./images/slide2.jpg" class="d-block w-100 slider_height" alt="...">
								<div class="carousel-caption d-md-block">
									<div class="row">
										<div class="col-12 col-lg-6 text-left">
							...
							<div class="carousel-item"> <img src="./images/slide33.jpg" class="d-block w-100 slider_height" alt="...">
								<div class="carousel-caption d-md-block">
									<div class="row">
										<div class="col-12 col-lg-6 text-left">
											<h1 class="text-capitalize">Next generation trading platform</h1>
