    ...
    <div class="row">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{URL('/')}}"><img src="./images/newlogo.png"></a>
                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        Products
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item  text-uppercase" href="#">JL Trading Point Platform</a></li>
                        ...
                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle text-light text-uppercase" href="/about.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        About
                    </a>
                            <ul class="dropdown-menu">
